...
> The childcare_costs data set contains information on the weekly costs of childcare across the counties of the U.S. and it contains age groups, program types, and years. It also looks to contain the provider counts, the county codes, and the states. The country data set contains a reference of the county code and names. 
